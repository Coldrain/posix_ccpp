...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.14 2013-02-28 15:31:12 GMT")
...
{	switch (p->type)
	...
	case SOAP_TYPE__ns1__getSupportCity:
		if (p->size < 0)
			SOAP_DELETE((_ns1__getSupportCity*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__getSupportCity*)p->ptr);
		break;
	case SOAP_TYPE__ns1__getSupportCityResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__getSupportCityResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__getSupportCityResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__getSupportProvince:
		if (p->size < 0)
			SOAP_DELETE((_ns1__getSupportProvince*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__getSupportProvince*)p->ptr);
		break;
	case SOAP_TYPE__ns1__getSupportProvinceResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__getSupportProvinceResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__getSupportProvinceResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__getSupportDataSet:
		if (p->size < 0)
			SOAP_DELETE((_ns1__getSupportDataSet*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__getSupportDataSet*)p->ptr);
		break;
	case SOAP_TYPE__ns1__getSupportDataSetResponse_getSupportDataSetResult:
		if (p->size < 0)
			SOAP_DELETE((_ns1__getSupportDataSetResponse_getSupportDataSetResult*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__getSupportDataSetResponse_getSupportDataSetResult*)p->ptr);
		break;
	case SOAP_TYPE__ns1__getSupportDataSetResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__getSupportDataSetResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__getSupportDataSetResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__getWeatherbyCityName:
		if (p->size < 0)
			SOAP_DELETE((_ns1__getWeatherbyCityName*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__getWeatherbyCityName*)p->ptr);
		break;
	case SOAP_TYPE__ns1__getWeatherbyCityNameResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__getWeatherbyCityNameResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__getWeatherbyCityNameResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__getWeatherbyCityNamePro:
		if (p->size < 0)
			SOAP_DELETE((_ns1__getWeatherbyCityNamePro*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__getWeatherbyCityNamePro*)p->ptr);
		break;
	case SOAP_TYPE__ns1__getWeatherbyCityNameProResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__getWeatherbyCityNameProResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__getWeatherbyCityNameProResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__DataSet:
		if (p->size < 0)
	...
	case SOAP_TYPE___ns1__getSupportCity:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__getSupportCity*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__getSupportCity*)p->ptr);
		break;
	case SOAP_TYPE___ns1__getSupportProvince:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__getSupportProvince*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__getSupportProvince*)p->ptr);
		break;
	case SOAP_TYPE___ns1__getSupportDataSet:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__getSupportDataSet*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__getSupportDataSet*)p->ptr);
		break;
	case SOAP_TYPE___ns1__getWeatherbyCityName:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__getWeatherbyCityName*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__getWeatherbyCityName*)p->ptr);
		break;
	case SOAP_TYPE___ns1__getWeatherbyCityNamePro:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__getWeatherbyCityNamePro*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__getWeatherbyCityNamePro*)p->ptr);
		break;
	case SOAP_TYPE___ns1__getSupportCity_:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__getSupportCity_*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__getSupportCity_*)p->ptr);
		break;
	case SOAP_TYPE___ns1__getSupportProvince_:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__getSupportProvince_*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__getSupportProvince_*)p->ptr);
		break;
	case SOAP_TYPE___ns1__getSupportDataSet_:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__getSupportDataSet_*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__getSupportDataSet_*)p->ptr);
		break;
	case SOAP_TYPE___ns1__getWeatherbyCityName_:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__getWeatherbyCityName_*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__getWeatherbyCityName_*)p->ptr);
		break;
	case SOAP_TYPE___ns1__getWeatherbyCityNamePro_:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__getWeatherbyCityNamePro_*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__getWeatherbyCityNamePro_*)p->ptr);
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_SOAP_ENV__Header:
		if (p->size < 0)
...
{
	register int id = soap_embed(soap, (void*)this, NULL, 0, tag, SOAP_TYPE__ns1__getSupportDataSetResponse_getSupportDataSetResult);
...
SOAP_FMAC1 _ns1__getSupportDataSetResponse_getSupportDataSetResult * SOAP_FMAC2 soap_instantiate__ns1__getSupportDataSetResponse_getSupportDataSetResult(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__getSupportDataSetResponse_getSupportDataSetResult);
		if (size)
			*size = sizeof(_ns1__getSupportDataSetResponse_getSupportDataSetResult);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__getSupportDataSetResponse_getSupportDataSetResult, n);
		if (size)
...
SOAP_FMAC1 _ns1__getWeatherbyCityNameProResponse * SOAP_FMAC2 soap_instantiate__ns1__getWeatherbyCityNameProResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__getWeatherbyCityNameProResponse);
		if (size)
			*size = sizeof(_ns1__getWeatherbyCityNameProResponse);
		((_ns1__getWeatherbyCityNameProResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__getWeatherbyCityNameProResponse, n);
		if (size)
...
SOAP_FMAC1 _ns1__getWeatherbyCityNamePro * SOAP_FMAC2 soap_instantiate__ns1__getWeatherbyCityNamePro(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__getWeatherbyCityNamePro);
		if (size)
			*size = sizeof(_ns1__getWeatherbyCityNamePro);
		((_ns1__getWeatherbyCityNamePro*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__getWeatherbyCityNamePro, n);
		if (size)
...
SOAP_FMAC1 _ns1__getWeatherbyCityNameResponse * SOAP_FMAC2 soap_instantiate__ns1__getWeatherbyCityNameResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__getWeatherbyCityNameResponse);
		if (size)
			*size = sizeof(_ns1__getWeatherbyCityNameResponse);
		((_ns1__getWeatherbyCityNameResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__getWeatherbyCityNameResponse, n);
		if (size)
...
SOAP_FMAC1 _ns1__getWeatherbyCityName * SOAP_FMAC2 soap_instantiate__ns1__getWeatherbyCityName(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__getWeatherbyCityName);
		if (size)
			*size = sizeof(_ns1__getWeatherbyCityName);
		((_ns1__getWeatherbyCityName*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__getWeatherbyCityName, n);
		if (size)
...
SOAP_FMAC1 _ns1__getSupportDataSetResponse * SOAP_FMAC2 soap_instantiate__ns1__getSupportDataSetResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__getSupportDataSetResponse);
		if (size)
			*size = sizeof(_ns1__getSupportDataSetResponse);
		((_ns1__getSupportDataSetResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__getSupportDataSetResponse, n);
		if (size)
...
SOAP_FMAC1 _ns1__getSupportDataSet * SOAP_FMAC2 soap_instantiate__ns1__getSupportDataSet(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__getSupportDataSet);
		if (size)
			*size = sizeof(_ns1__getSupportDataSet);
		((_ns1__getSupportDataSet*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__getSupportDataSet, n);
		if (size)
...
SOAP_FMAC1 _ns1__getSupportProvinceResponse * SOAP_FMAC2 soap_instantiate__ns1__getSupportProvinceResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__getSupportProvinceResponse);
		if (size)
			*size = sizeof(_ns1__getSupportProvinceResponse);
		((_ns1__getSupportProvinceResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__getSupportProvinceResponse, n);
		if (size)
...
SOAP_FMAC1 _ns1__getSupportProvince * SOAP_FMAC2 soap_instantiate__ns1__getSupportProvince(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__getSupportProvince);
		if (size)
			*size = sizeof(_ns1__getSupportProvince);
		((_ns1__getSupportProvince*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__getSupportProvince, n);
		if (size)
...
SOAP_FMAC1 _ns1__getSupportCityResponse * SOAP_FMAC2 soap_instantiate__ns1__getSupportCityResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__getSupportCityResponse);
		if (size)
			*size = sizeof(_ns1__getSupportCityResponse);
		((_ns1__getSupportCityResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__getSupportCityResponse, n);
		if (size)
...
SOAP_FMAC1 _ns1__getSupportCity * SOAP_FMAC2 soap_instantiate__ns1__getSupportCity(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__getSupportCity);
		if (size)
			*size = sizeof(_ns1__getSupportCity);
		((_ns1__getSupportCity*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__getSupportCity, n);
		if (size)
...
SOAP_FMAC1 struct __ns1__getWeatherbyCityNamePro_ * SOAP_FMAC2 soap_instantiate___ns1__getWeatherbyCityNamePro_(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__getWeatherbyCityNamePro_);
		if (size)
			*size = sizeof(struct __ns1__getWeatherbyCityNamePro_);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__getWeatherbyCityNamePro_, n);
		if (size)
...
SOAP_FMAC1 struct __ns1__getWeatherbyCityName_ * SOAP_FMAC2 soap_instantiate___ns1__getWeatherbyCityName_(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__getWeatherbyCityName_);
		if (size)
			*size = sizeof(struct __ns1__getWeatherbyCityName_);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__getWeatherbyCityName_, n);
		if (size)
...
SOAP_FMAC1 struct __ns1__getSupportDataSet_ * SOAP_FMAC2 soap_instantiate___ns1__getSupportDataSet_(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__getSupportDataSet_);
		if (size)
			*size = sizeof(struct __ns1__getSupportDataSet_);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__getSupportDataSet_, n);
		if (size)
...
SOAP_FMAC1 struct __ns1__getSupportProvince_ * SOAP_FMAC2 soap_instantiate___ns1__getSupportProvince_(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__getSupportProvince_);
		if (size)
			*size = sizeof(struct __ns1__getSupportProvince_);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__getSupportProvince_, n);
		if (size)
...
SOAP_FMAC1 struct __ns1__getSupportCity_ * SOAP_FMAC2 soap_instantiate___ns1__getSupportCity_(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__getSupportCity_);
		if (size)
			*size = sizeof(struct __ns1__getSupportCity_);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__getSupportCity_, n);
		if (size)
...
SOAP_FMAC1 struct __ns1__getWeatherbyCityNamePro * SOAP_FMAC2 soap_instantiate___ns1__getWeatherbyCityNamePro(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__getWeatherbyCityNamePro);
		if (size)
			*size = sizeof(struct __ns1__getWeatherbyCityNamePro);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__getWeatherbyCityNamePro, n);
		if (size)
...
SOAP_FMAC1 struct __ns1__getWeatherbyCityName * SOAP_FMAC2 soap_instantiate___ns1__getWeatherbyCityName(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__getWeatherbyCityName);
		if (size)
			*size = sizeof(struct __ns1__getWeatherbyCityName);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__getWeatherbyCityName, n);
		if (size)
...
SOAP_FMAC1 struct __ns1__getSupportDataSet * SOAP_FMAC2 soap_instantiate___ns1__getSupportDataSet(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__getSupportDataSet);
		if (size)
			*size = sizeof(struct __ns1__getSupportDataSet);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__getSupportDataSet, n);
		if (size)
...
SOAP_FMAC1 struct __ns1__getSupportProvince * SOAP_FMAC2 soap_instantiate___ns1__getSupportProvince(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__getSupportProvince);
		if (size)
			*size = sizeof(struct __ns1__getSupportProvince);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__getSupportProvince, n);
		if (size)
...
SOAP_FMAC1 struct __ns1__getSupportCity * SOAP_FMAC2 soap_instantiate___ns1__getSupportCity(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__getSupportCity);
		if (size)
			*size = sizeof(struct __ns1__getSupportCity);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__getSupportCity, n);
		if (size)
...
SOAP_FMAC3 _ns1__getWeatherbyCityNameProResponse ** SOAP_FMAC4 soap_in_PointerTo_ns1__getWeatherbyCityNameProResponse(struct soap *soap, const char *tag, _ns1__getWeatherbyCityNameProResponse **a, const char *type)
{
	...
	*a = NULL;
	...
	{	_ns1__getWeatherbyCityNameProResponse ** p = (_ns1__getWeatherbyCityNameProResponse **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE__ns1__getWeatherbyCityNameProResponse, sizeof(_ns1__getWeatherbyCityNameProResponse), 0);
		a = p;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__getWeatherbyCityNameProResponse(struct soap *soap, _ns1__getWeatherbyCityNameProResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__getWeatherbyCityNameProResponse(soap, tag?tag:"ns1:getWeatherbyCityNameProResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 _ns1__getWeatherbyCityNameResponse ** SOAP_FMAC4 soap_in_PointerTo_ns1__getWeatherbyCityNameResponse(struct soap *soap, const char *tag, _ns1__getWeatherbyCityNameResponse **a, const char *type)
{
	...
	*a = NULL;
	...
	{	_ns1__getWeatherbyCityNameResponse ** p = (_ns1__getWeatherbyCityNameResponse **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE__ns1__getWeatherbyCityNameResponse, sizeof(_ns1__getWeatherbyCityNameResponse), 0);
		a = p;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__getWeatherbyCityNameResponse(struct soap *soap, _ns1__getWeatherbyCityNameResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__getWeatherbyCityNameResponse(soap, tag?tag:"ns1:getWeatherbyCityNameResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 _ns1__getSupportDataSetResponse ** SOAP_FMAC4 soap_in_PointerTo_ns1__getSupportDataSetResponse(struct soap *soap, const char *tag, _ns1__getSupportDataSetResponse **a, const char *type)
{
	...
	*a = NULL;
	...
	{	_ns1__getSupportDataSetResponse ** p = (_ns1__getSupportDataSetResponse **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE__ns1__getSupportDataSetResponse, sizeof(_ns1__getSupportDataSetResponse), 0);
		a = p;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__getSupportDataSetResponse(struct soap *soap, _ns1__getSupportDataSetResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__getSupportDataSetResponse(soap, tag?tag:"ns1:getSupportDataSetResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 _ns1__getSupportProvinceResponse ** SOAP_FMAC4 soap_in_PointerTo_ns1__getSupportProvinceResponse(struct soap *soap, const char *tag, _ns1__getSupportProvinceResponse **a, const char *type)
{
	...
	*a = NULL;
	...
	{	_ns1__getSupportProvinceResponse ** p = (_ns1__getSupportProvinceResponse **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE__ns1__getSupportProvinceResponse, sizeof(_ns1__getSupportProvinceResponse), 0);
		a = p;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__getSupportProvinceResponse(struct soap *soap, _ns1__getSupportProvinceResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__getSupportProvinceResponse(soap, tag?tag:"ns1:getSupportProvinceResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 _ns1__getSupportCityResponse ** SOAP_FMAC4 soap_in_PointerTo_ns1__getSupportCityResponse(struct soap *soap, const char *tag, _ns1__getSupportCityResponse **a, const char *type)
{
	...
	*a = NULL;
	...
	{	_ns1__getSupportCityResponse ** p = (_ns1__getSupportCityResponse **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE__ns1__getSupportCityResponse, sizeof(_ns1__getSupportCityResponse), 0);
		a = p;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__getSupportCityResponse(struct soap *soap, _ns1__getSupportCityResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__getSupportCityResponse(soap, tag?tag:"ns1:getSupportCityResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
